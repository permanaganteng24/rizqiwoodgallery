...
class MidtransPaymentTest extends TestCase
{
    ...
    public function test_pay_now_generates_a_snap_token_for_an_unpaid_order(): void
    {
        ...
        // Midtrans\Snap is a plain static class shipped by midtrans/midtrans-php
        // (not a Laravel facade), so it is intercepted via Mockery's alias
        // mocking to avoid making a real API call during tests.
