        ...
        <form wire:submit.prevent="placeOrder" class="lg:grid lg:grid-cols-12 lg:gap-x-12 xl:gap-x-16">
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea wire:model="notes" rows="1" placeholder="Optional notes" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm outline-none"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-5 mt-12 lg:mt-0">
                <div class="bg-white border border-gray-200 rounded-2xl shadow-xl shadow-gray-100 p-8 sticky top-24">
                    ...
                    <div class="border-t border-gray-100 pt-6 space-y-4">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <div class="text-right">
                                ...
                                @elseif($location_type === 'international' || $selectedCity)
                                    <p class="font-bold text-amber-600">Pending</p>
                                    <p class="text-[10px] text-gray-400">Calculated Manually</p>
                                @else
                                    <span class="text-gray-400">-</span>
                                @endif
                            </div>
                    ...
                    <button type="submit" wire:loading.attr="disabled" class="w-full mt-8 bg-[#6B4226] text-white font-bold py-4 rounded-full shadow-lg hover:bg-[#5D3A20] hover:shadow-xl transition duration-300 transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2">
