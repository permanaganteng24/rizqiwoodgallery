    ...
    <div class="mb-6">
            ...
            <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-4 items-start shadow-sm">
                ...
                <div>
                    ...
                    <p class="text-sm text-amber-700 mt-1">
                        Your order is being reviewed by our admin team to determine cargo shipping costs (International/Inter-island). 
        ...
        @elseif($order->order_status == 'waiting_payment')
            <div class="bg-green-50 border border-green-200 rounded-xl p-4 flex gap-4 items-start shadow-sm">
                ...
                <button class="bg-green-700 text-white px-6 py-2 rounded-lg font-bold hover:bg-green-800 transition shadow-md whitespace-nowrap">
                    Pay Now
                </button>
            </div>
        @endif
                ...
                <ul class="divide-y divide-gray-200">
                    @foreach ($order->items as $item)
                        <li class="p-6 flex gap-4">
                            <div class="h-20 w-20 flex-shrink-0 overflow-hidden rounded-md border border-gray-200 bg-gray-100">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                    Qty: {{ number_format($item->quantity) }} × Rp {{ number_format($item->price_per_unit, 0, ',', '.') }}
                                </p>
                            </div>
